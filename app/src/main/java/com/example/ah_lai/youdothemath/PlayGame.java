...
public class PlayGame extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            ...
            scoreTxt.setText("com.example.ah_lai.youdothemath.Score: "+exScore);
        }
        else{
            //get passed level
        ...
        if(view.getId()==R.id.enter){
            ...
            if(!answerContent.endsWith("?")){
                ...
                if(enteredAnswer==answer){
                    //correct
                    scoreTxt.setText("com.example.ah_lai.youdothemath.Score: "+(exScore+1));
                    ...
                    setHighScore();
                    //incorrect
                    scoreTxt.setText("com.example.ah_lai.youdothemath.Score: 0");
